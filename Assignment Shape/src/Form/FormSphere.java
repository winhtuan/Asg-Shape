...
public class FormSphere extends TransitionsForm {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/AreaIcon/SphereArea.png"))); // NOI18N
        ...
        jLabel4.setText("Enter The Radius");

        txtRadius.setForeground(new java.awt.Color(0, 0, 0));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtVolume, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtRadius, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(6, 6, 6)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(2, 2, 2)
                        .addComponent(txtRadius, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnCacuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCacuActionPerformed
        try {
            String radiusString = txtRadius.getText().trim();
            if (radiusString.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please enter a radius.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            double radius = Double.parseDouble(radiusString);
            if (radius <= 0) {
                reset();
                JOptionPane.showMessageDialog(this, "Please enter a positive radius.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            String unit = (String) cbUnit.getSelectedItem();
            Sphere sphere = new Sphere(radius);
            ShapeList.addShape(sphere);
            ...
            reset();
            JOptionPane.showMessageDialog(this, "Invalid radius. Please enter a number.", "Error", JOptionPane.ERROR_MESSAGE);
        } 
