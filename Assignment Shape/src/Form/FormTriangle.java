...
public class FormTriangle extends TransitionsForm {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Triangle Shape");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/AreaIcon/TriangleArea.png"))); // NOI18N
        ...
        jLabel4.setText("Enter The Base");

        txtbase.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void btnCacuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCacuActionPerformed
        try {
            String baseString = txtbase.getText().trim();
            String heightString = txtheight.getText().trim();
            
            if (baseString.isEmpty() && heightString.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please enter the input.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            double side = Double.parseDouble(baseString);
            double height = Double.parseDouble(heightString);
            if (side <= 0 && height <= 0) {
                reset();
                JOptionPane.showMessageDialog(this, "Please enter a positive.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
